...
* **`UNION`** removes duplicates. If, theoretically, a user was named "Avengers" and the top movie was also named "Avengers", `UNION` would merge them into one row (returning only 1 row instead of 2).
